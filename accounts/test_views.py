...
class RegisterViewTestCase(TestCase):
    ...
    def test_register_view_post_valid_form(self):
        ...
        self.assertEqual(response.status_code, 302)  # Redirects to home upon successful registration
        self.assertEqual(response.url, reverse('home'))  # Ensure redirection to the home page
    ...
    def test_register_view_authenticated_user(self):
        # Authenticate user
        self.client.force_login(User.objects.create_user(username='existing_user', password='password123'))
        response = self.client.get(self.register_url)
